...
export default async function RootLayout({ children }: LayoutProps<"/">) {
  ...
  return <html lang="en" data-theme={theme}><body>
    <header><Link href="/" className="brand"><span className="brandMark" aria-hidden="true">▂▆▃</span> uptime<span style={{ fontWeight: 400, color: "var(--muted)", fontSize: 13 }}> / workspace</span></Link><ThemeToggle initialTheme={theme} /></header>
    {children}
